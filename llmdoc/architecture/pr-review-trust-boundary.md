...
- Reviewed/untrusted data: PR metadata, commits, full head checkout, docs and `base...head` diff.
...
- Reviewer checkouts use `persist-credentials: false`; Agent processes receive model credentials but
  no GitHub/PAT token.
